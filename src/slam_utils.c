...
bool slam_dir_exist(const char* file) {
    return access(file, F_OK) == 0;
}
bool slam_dir_readable(const char* file) {
    return access(file, R_OK) == 0;
}
bool slam_dir_writable(const char* file) {
    return access(file, W_OK) == 0;
}
bool slam_dir_accessable(const char* file) {
