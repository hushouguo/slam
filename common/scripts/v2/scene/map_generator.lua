...
--
function Map:create_event_object(event_baseid, coord)
...
--
function Map:create_obstacle_object(obstacle_baseid, coord)
...
function Map:tiles_pattern_generator(link_direction)
	local t = {
		...
		[Direction.RIGHT] = {
			MapPattern.R, MapPattern.LR, MapPattern.RI, MapPattern.RR
		},
		[Direction.UP] = {
			MapPattern.I, MapPattern.LI, MapPattern.RI, MapPattern.LRI
		},
		[Direction.DOWN] = {
			MapPattern.I, MapPattern.LI, MapPattern.RI, MapPattern.LRI, MapPattern.L, MapPattern.R, MapPattern.LR
		},		
...
--
function Map:tiles_obstacle_STICK_generator()
...
--
function Map:tiles_obstacle_BLOCK_generator(blocksize)
...
--
function Map:tiles_entry_coord()
