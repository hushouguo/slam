...
record.delete = function(entity)
	...
	cc.ScriptDebugLog(string.format("entity: %d, delete record: %s", entity.id, tostring(jsonstr)))
    cc.ScriptEntitySerialize(entity.id, jsonstr)
end
...
record.serialize = function(entity)
    ...
    local json = require('tools/json')
	local jsonstr = json.encode(entity.record)
	cc.ScriptDebugLog(string.format("entity: %d, serialize: %s", entity.id, tostring(jsonstr)))
    cc.ScriptEntitySerialize(entity.id, jsonstr)
end
...
record.unserialize = function(entity)
    local json = require('tools/json')
    local jsonstr = cc.ScriptEntityUnserialize(entity.id)
	cc.ScriptDebugLog(string.format("entity: %d, unserialize: %s", entity.id, tostring(jsonstr)))
