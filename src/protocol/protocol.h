...
extern "C" {
	extern int protocol_load_descriptor(const char* filename); // filename also is folder
	extern int protocol_reg_message(msgid_t msgid, const char* name);
	extern ssize_t protocol_decode(lua_State* L, msgid_t* msgid, const void* buf, size_t bufsize);
	extern ssize_t protocol_encode(lua_State* L, msgid_t msgid, void* buf, size_t bufsize);
}
