...
extern bool slam_dir_exist(const char* file);
extern bool slam_dir_readable(const char* file);
extern bool slam_dir_writable(const char* file);
extern bool slam_dir_accessable(const char* file);
